...
| [Phatty](https://github.com/BrendanJamesLynskey/Phatty) | Web-audio DAW groovebox — a TB-303-style acid synth, an 808/909-style synthesized drum machine, a subtractive poly synth and FX, with a phat master bus, 18 presets based on classic tracks (Acid Tracks, Strings of Life, Planet Rock, The Bells, Da Funk…), a musical randomizer, and desktop & mobile layouts |
