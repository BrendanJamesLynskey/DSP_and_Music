...
| [ROLLER — Drum & Bass](https://github.com/BrendanJamesLynskey/Synth_DrumAndBass) | Drum & bass engine — a **Reese bass** (three detuned saws, swept notches, drive, ladder) crossed over with a mono sine **sub**, eight synthesized breakbeat voices on a compressed break bus, pads, stabs and a hoover, tempo-synced delay + convolution reverb, and a 16th-note sequencer with stutter **chops**, auto **fills**, humanise and a one-key **drop**; 12 presets from liquid to jungle to neurofunk; desktop & mobile |
